(function () {
  ...
  function initSupabase() {
    ...
    function fetchAndRender() {
      ...
      fetchInFlight = true;
      // Ofertas publicadas por empresas en Incloo (fuente vacía)
      sbGet("jobs?estado=eq.publicada&fuente=is.null&order=created_at.desc&limit=500")
        .then(function(rows) {
          fetchInFlight = false;
          rows = rows || [];

          // Empresas y patrones bloqueados en cliente (falsos positivos)
